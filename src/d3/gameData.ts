...
class Diablo3GameData {
  ...
  async getSeasonIndex(): Promise<ISeasonIndex> {
    try {
      const response = await this.axios.get<ISeasonIndex>(
        encodeURI(`${this.gameBaseUrlPath}/season`)
      );
      return response.data;
    } catch (error) {
      console.log(error);
      throw new Error(
        `Diablo 3 Game Data Error :: Error fetching the season index.`
      );
    }
  }
  ...
  async getSeason(seasonId: number): Promise<ISeason> {
    try {
      const response = await this.axios.get<ISeason>(
        encodeURI(`${this.gameBaseUrlPath}/season/${seasonId}`)
      );
      return response.data;
    } catch (error) {
      console.log(error);
      throw new Error(
        `Diablo 3 Game Data Error :: Error fetching the specified season.`
      );
    }
  }
  ...
  ): Promise<ISeasonLeaderboard> {
    try {
      const response = await this.axios.get<ISeasonLeaderboard>(
        encodeURI(
      ...
      console.log(error);
      throw new Error(
        `Diablo 3 Game Data Error :: Error fetching the specified season leaderboard.`
      );
    }
  }
  ...
  async getEraIndex(): Promise<IEraIndex> {
    try {
      const response = await this.axios.get<IEraIndex>(
        encodeURI(`${this.gameBaseUrlPath}/era`)
      );
      return response.data;
    } catch (error) {
      console.log(error);
      throw new Error(
        `Diablo 3 Game Data Error :: Error fetching the era index.`
      );
    }
  }
  ...
  async getEra(eraId: number): Promise<IEra> {
    try {
      const response = await this.axios.get<IEra>(
        encodeURI(`${this.gameBaseUrlPath}/era/${eraId}`)
      );
      return response.data;
    } catch (error) {
      console.log(error);
      throw new Error(
        `Diablo 3 Game Data Error :: Error fetching the specified era.`
      );
    }
  }
   ...
   */
  async getEraLeaderboard(
    eraId: number,
    leaderboardId: string
  ): Promise<IEraLeaderboard> {
    try {
      const response = await this.axios.get<IEraLeaderboard>(
        encodeURI(
      ...
      console.log(error);
      throw new Error(
        `Diablo 3 Game Data Error :: Error fetching the specified era leaderboard.`
      );
    }
  }
}
