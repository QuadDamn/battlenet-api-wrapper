...
class WowGameData {
   ...
   */
  async getMythicRaidLeaderboard(
    raid: string,
    faction: string
  ): Promise<object> {
    return await this._handleApiCall(
   ...
   * @param connectedRealmId The ID of the connected realm.
   */
  async getMythicKeystoneLeaderboardsIndex(
   ...
   */
  async getMythicKeystoneLeaderboard(
    connectedRealmId: number,
    dungeonId: number,
    period: number
  ): Promise<object> {
   ...
   * @param playableClassId The ID of the playable class.
   */
  async getPlayableClassPvpTalentSlots(
   ...
   */
  async getPlayableSpecialization(
    playableSpecializationId: number
  ): Promise<object> {
    return await this._handleApiCall(
